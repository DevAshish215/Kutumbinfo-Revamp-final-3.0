...
function loadComponents() {
    ...
    const navbarPromise = fetchComponent(getBasePath() + "navbar_p.html", "navbar-placeholder")
        .then(() => {
    ...
    const navbarRootPromise = fetchComponent(getBasePath() + "navbar_p.html", "navbar_root-placeholder");
